Mapping PCIDSS requirements to administrative and technical reviews
...
Requirement type: Technical task(s)
Tasks example:
...
Requirement type: Administrative task(s)
Tasks example: Limit access to system components and cardholder data to only those individuals whose job requires such access
8. Requirement: Identify and authenticate access to systems components
Requirement type: Administrative task(s)
Tasks example: Remove or disable unused accounts within 90 days, assign unique ID for users before allowing them to access system components or cardholder data
9. Requirement: Restrict physical access to cardholder data
Requirement type: Administrative task(s)
Tasks example: Identify on-site personel, control physical access
...
Requirement type: Technical task(s)
Tasks example: Implement audit trails
11. Requirement: Regulary test security systems and processes
Requirement type: Technical task(s)
Tasks example: Maintaining inventory of devices, running external and internal vulnerability scans quarterly, penetration testing according to requirement 11.3.
...
Requirement type: Administrative task(s)
Tasks example: Establish a security policy, maintain security policy, train staff. PCI DSS requirements 12.-12.10.6.
