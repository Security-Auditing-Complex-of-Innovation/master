...
Hence, we selected a few of the more critical and subject-wise interesting vulnerabilities, for example: Shellshock and weak encryption mechanisms. These are discussed in more detail from the ldil.de perspective with PCI DSS angle.
...
**Vulnerable Target**: 79.99.193.10, extranet.ldil.de, the Extranet service.
...
**Vulnerable Target**: 79.99.193.20, www.ldil.de
